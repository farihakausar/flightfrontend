    ...
    <div className="font-sans">
      ...
      <header className="bg-white shadow-md py-4">
        <div className="container mx-auto flex justify-between items-center px-4">
          <h1 className="text-2xl font-bold text-green-600">
            FRIDAY<span className="text-black">AD</span>
          </h1>
        ...
        <div className="container mx-auto px-4 flex flex-wrap items-center">
          ...
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
            ...
            <p className="text-lg text-left">
              Got something to share? Are you an expert in your area or have a
              passion for something and want to share your stories with
              Friday-Ad’s growing community? We want to hear from you!
            </p>
          </div>
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-4">
            Are you wanting to share advice or stories to Friday-Ad’s growing
            local and global community? Get in touch with us!
          </p>
          <p className="mb-8">
            Topics include:{" "}
            <strong>
              Home and Garden, Upcycling, Antiques, Pets/Animals, Motors,
              Leisure, Beauty, Fashion, Baby and Kids, Community, Events, Jobs,
              Recruitment and Property Services
            </strong>
            .
          </p>
        ...
        <div className="container mx-auto px-4 flex flex-wrap items-center">
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
            ...
            <p className="text-gray-700">
              By writing content for us, your post will be published on our site
              that receives over <strong>1.5 million visits a month</strong>.
              Plus, we promote content to maximize your exposure!
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {writers.map((writer, index) => (
              <div
                key={index}
                className="bg-white p-6 shadow-lg rounded text-center"
              >
                <img
                  src={writer.image}
                  alt={writer.name}
...
const writers = [
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/150",
    description:
      "Sarah works for 'bubbl' a content and digital marketing business...",
  },
  {
    name: "Kirsten Hubert",
    image: "https://via.placeholder.com/150",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/150",
    description:
      "Katie is a qualified Nanny passionate about supporting parents...",
  },
];
